    ...
    return (
        <FormWrapper>
            <form onSubmit={props.handleSubmit}>
                ...
                <Field>
                    <input onChange={props.handleChange} type="text" name="description" placeholder="Description" value={props.review.description}/> 
                </Field>
                <Field>
                    <RatingContainer>
                        <RatingBoxTitle>Bingeworthy Score (out of 5):</RatingBoxTitle>
